...
{
    /// <summary>
    /// Possible interaction states for <see cref="IInteractable"/>s.
    /// </summary>
    [Flags]
    public enum InteractionState
    {
        /// <summary>
        /// The <see cref="IInteractable"/> is in its default state, that is
        /// it's not being interacted with.
        /// </summary>
        Normal = 0,
        /// <summary>
        /// The <see cref="IInteractable"/> is in its focused state,
        /// that is it's being targeted by at least one <see cref="Interactors.IInteractor"/>.
        /// </summary>
        Focused,
        /// <summary>
        /// The <see cref="IInteractable"/> is in its selected state,
